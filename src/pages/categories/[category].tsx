...
import {
    useProductsCategoriesPaginationQuery,
    fetchProductsCategories,
} from "@framework/product/get-products-categories-seo";
...
const Search: NextPage<{}> & { Layout: typeof Layout } = () => {
    ...
    const { isLoading, data, error } = useProductsCategoriesPaginationQuery(
        {
            ...query,
        },
    ...
    const { pagination, products, filter, favorites, seo } = data ?? {};
    return (
        <>
            <Container clean>
...
export const getServerSideProps: GetServerSideProps = async ({
    ...
    await queryClient.prefetchQuery(
        ...
        async () => fetchProductsCategories(query),
    );
    return {
        props: {
