...
const ForgetPasswordForm = () => {
    ...
    return (
        <div className="py-6 px-5 sm:p-8 bg-white mx-auto w-full sm:w-96 md:w-450px border border-gray-300">
            ...
            {!request ? (
                ...
                <div className="flex flex-col justify-center items-center">
                    <FaRegCheckCircle className="w-1/4 h-1/4 text-green-400" />
                    <p className="text-sm">
                        Chúng tôi đã gửi một email hướng dẫn khôi phục
                    </p>
                </div>
            )}
